...
public class Config {
    @Bean
    CommandLineRunner commandLineRunner(EmployerRepository employerRepository, CandidateRepository candidateRepository, AdRepository adRepository, JobRepository jobRepository){
        return args -> {
